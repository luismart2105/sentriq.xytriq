...
@section('content')
    ...
    <section class="section section--light"><div class="container legal-copy"><h2>Tratamiento de datos de contacto</h2><p><strong>{{ config('sentriq.privacy.responsible_name') }}</strong>, quien opera comercialmente como Sentriq, es responsable del tratamiento de los datos personales recopilados mediante este sitio.</p><p>Sentriq recopilará los datos que envíes mediante el formulario exclusivamente para responder tu solicitud, dar seguimiento comercial y, cuando corresponda, preparar una visita o cotización.</p><p>Los datos pueden incluir nombre, teléfono, correo, municipio, servicio de interés y la descripción que decidas proporcionar. No se publicarán y su acceso se limitará al personal autorizado.</p><p>Para solicitar acceso, rectificación, cancelación u oposición, utiliza provisionalmente <a href="mailto:{{ config('sentriq.contact.email') }}">{{ config('sentriq.contact.email') }}</a>.</p><p><strong>Antes de producción:</strong> confirmar domicilio, mecanismos ARCO, transferencias, plazos de conservación y texto definitivo.</p></div></section>
@endsection
